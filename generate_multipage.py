        ...
        function renderCatalog() {
            ...
            grid.innerHTML = pageCars.map(car => {
                ...
                return '<div class="bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between group">'
                    ...
                    + '<span class="px-2.5 py-1 rounded-lg bg-slate-950/85 backdrop-blur-md text-amber-300 font-mono text-[10px] font-bold border border-slate-700/60 shadow-sm">STOCK: ' + car.stock_no + '</span>'
                    + '<span class="px-2.5 py-1 rounded-lg bg-amber-400 text-slate-950 font-mono text-[11px] font-extrabold shadow-sm">GRED ' + car.grade + '</span>'
                    + '</div>'
                    + '<div class="absolute bottom-2.5 inset-x-2.5 flex items-center justify-between gap-2 z-10">'
                    + '<span class="px-2.5 py-1 rounded-lg bg-emerald-800/95 backdrop-blur-md text-white text-[10px] font-bold shadow-sm">' + car.status + '</span>'
                    + '<span class="px-2.5 py-1 rounded-lg bg-slate-950/85 backdrop-blur-md text-white text-[10px] font-semibold border border-slate-700 shadow-sm">' + imgCount + ' Foto</span>'
                    + '</div>'
                    + '</div>'
